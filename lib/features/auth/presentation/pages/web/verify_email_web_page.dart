...
class VerifyEmailWebPage extends ConsumerStatefulWidget {
  const VerifyEmailWebPage({super.key});

  @override
  ConsumerState<VerifyEmailWebPage> createState() => _VerifyEmailWebPageState();
}

class _VerifyEmailWebPageState extends ConsumerState<VerifyEmailWebPage> {
    ...
    return CustomScaffold(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            LottieBuilder.asset('assets/animations/verify_email.json'),
            Column(
              spacing: 15,
              children: [
                CustomHeader(
