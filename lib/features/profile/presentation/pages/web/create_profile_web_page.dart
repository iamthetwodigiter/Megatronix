...
class CreateProfileWebPage extends ConsumerStatefulWidget {
  final UserEntity user;

  const CreateProfileWebPage({
    super.key,
    required this.user,
  });

  @override
  ConsumerState<CreateProfileWebPage> createState() => _CreateProfilePageState();
}

class _CreateProfilePageState extends ConsumerState<CreateProfileWebPage> {
