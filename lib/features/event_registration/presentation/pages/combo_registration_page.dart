...
class ComboRegistrationPage extends ConsumerStatefulWidget {
  final ComboEntity combo;

  const ComboRegistrationPage({
    super.key,
    required this.combo,
  });

  @override
  ConsumerState<ComboRegistrationPage> createState() =>
      _ComboRegistrationPageState();
}

class _ComboRegistrationPageState extends ConsumerState<ComboRegistrationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<EventRegistrationState>(
      ...
      (previous, current) {
        ...
        if (current.comboRegistrations == null ||
            current.error != null && context.mounted) {
          AppErrorHandler.handleError(
            context,
            'Error',
