...
class EventByGidWebPage extends ConsumerStatefulWidget {
  final String gid;
  const EventByGidWebPage({
    super.key,
    required this.gid,
  });

  @override
  ConsumerState<EventByGidWebPage> createState() => _EventByGidWebPageState();
}

class _EventByGidWebPageState extends ConsumerState<EventByGidWebPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (eventByGidState.eventByGID != null && eventByGidState.eventByGID!.isNotEmpty) {
      return CustomWebScaffold(
        title: 'Registered Events',
        child: Container(
          height: size.height,
